...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description= "Extract Dell firmware update (HDR) from packaged PE.")
    parser.add_argument('-o', '--output', default=None, help="Filename to write extracted HDR update.")
    ...
    with open(args.file, 'r') as fh: data = fh.read()
    ...
    with open(name, 'wb') as fh: fh.write(hdr_data)
